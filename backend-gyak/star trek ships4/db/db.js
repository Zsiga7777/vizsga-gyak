...
db.prepare("CREATE TABLE IF NOT EXISTS ships(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, class TEXT, raceFaction TEXT, length NUMBER, crew NUMBER, maxWarp NUMBER, armament TEXT, shieldType TEXT, hullMaterial TEXT, role TEXT)").run()
...
export const deleteById = (id) => db.prepare("DELETE FROM ships WHERE id = ?").run(id)